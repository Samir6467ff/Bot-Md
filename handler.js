...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title:'「 تــــحــذيـــر!! 」', body: author, thumbnail: img6, sourceUrl:'https://whatsapp.com/channel/0029Vael6wMJP20ze3IXJk0z' } } } }, aa);
